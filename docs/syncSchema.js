...
// Source of truth for schema interfaces lives in src/core/JSONParser.ts
const PARSER_FILE = path.join(__dirname, '../src/core/JSONParser.ts');
...
function validateCompleteExample() {
  // Use CJS wrapper to avoid ESM require issues in this project
  const { validateExampleStructure } = require('./validateExample.cjs');
