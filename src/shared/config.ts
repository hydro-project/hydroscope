...
export const LAYOUT_CONSTANTS = {
  ...
  EDGE_DISTANCE_WARNING_THRESHOLD: 5000, // Distance threshold for edge validation warnings (px)
  SUPPRESS_EDGE_VALIDATION_NODE_THRESHOLD: 20, // Suppress edge validation warnings for graphs with more than this many nodes
...
// Styling constants for edges and highlights
