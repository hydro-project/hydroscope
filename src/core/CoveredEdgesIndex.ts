...
export class CoveredEdgesIndex {
  ...
  private getContainerAncestors(
    ...
    while (currentContainer) {
      ...
      // TODO: This is wrong - nodeContainers is node->container, not container->parent
      // For now, don't traverse up the hierarchy
      currentContainer = undefined; // nodeContainers.get(currentContainer);
    }
