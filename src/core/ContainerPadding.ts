...
export class ContainerPadding {
   ...
   */
  static getExpandedContainerDimensions(
    contentWidth: number,
    ...
    return {
      ...
      height: Math.max(contentHeight + labelPadding.height, LAYOUT_CONSTANTS.MIN_CONTAINER_HEIGHT),
    };
  }
  ...
  static getReactFlowDimensions(container: {
    ...
    const baseHeight =
      container.expandedDimensions?.height || LAYOUT_CONSTANTS.MIN_CONTAINER_HEIGHT;
