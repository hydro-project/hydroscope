...
export const HydroscopeCore = React.forwardRef<
  HydroscopeCoreRef,
  HydroscopeCoreProps
>(
  (
    ...
    useEffect(() => {
      try {
        ...
        const initialLayoutState =
          visualizationStateRef.current.getLayoutState();
    ...
    const updateReactFlowData = useCallback(async () => {
      ...
      try {
        ...
        debugLog("ReactFlow data updated", {
        ...
        const checkInterval = setInterval(() => {
          if (visualizationStateRef.current) {
            const currentLayoutState =
              visualizationStateRef.current.getLayoutState();
            if (
              currentLayoutState.phase === "initial" ||
    ...
    const status = useMemo(
      () => ({
        ...
        reactFlowData,
        isInitialized: !!(
          visualizationStateRef.current && asyncCoordinatorRef.current
        ),
        isLayouting:
          layoutState.phase === "laying_out" ||
          layoutState.phase === "rendering",
