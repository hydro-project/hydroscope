...
import { SearchResults, type SearchResultsProps } from '../components/SearchResults.js';
...
describe('SearchResults Component', () => {
  const mockSearchResults: SearchResult[] = [
    {
      ...
      label: 'Test Node One',
      type: 'node',
      matchIndices: [[0, 4], [5, 9]] // "Test" and "Node"
    },
    {
      id: 'container1',
  ...
  describe('Current Result Selection', () => {
    ...
    it('should change current result when index changes', () => {
      const { rerender } = render(<SearchResults {...defaultProps} currentResultIndex={0} />);
