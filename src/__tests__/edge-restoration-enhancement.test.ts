...
describe("Enhanced Edge Restoration", () => {
  ...
  describe("Pre-restoration Validation", () => {
    it("should validate edge restoration preconditions", () => {
      // Create test data
  ...
  describe("Rollback Functionality", () => {
    it("should provide rollback operations for restoration", () => {
      // Create test data
      const container: Container = {
        id: "container1",
        label: "Test Container",
    ...
    it("should successfully rollback restoration operations", () => {
      // Create test data
      const container: Container = {
        id: "container1",
        label: "Test Container",
  ...
  describe("Integration with Existing Functionality", () => {
    it("should maintain compatibility with existing edge aggregation", () => {
      ...
      visualizationState.expandContainer("child");
