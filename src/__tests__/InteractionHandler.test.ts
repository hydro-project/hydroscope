...
import { InteractionHandler, type ClickEvent } from '../core/InteractionHandler.js';
...
describe('InteractionHandler Click Event Processing', () => {
  ...
  describe('Node Click Handling', () => {
    ...
    it('should trigger layout update for significant label changes', () => {
      ...
      node.longLabel = 'This is a very long label that is much longer than the short one';
      state.addNode(node);
  ...
  describe('Configuration Management', () => {
    it('should use default configuration', () => {
      ...
      const defaultHandler = new InteractionHandler(state, mockAsyncCoordinator);
    ...
    it('should accept custom configuration', () => {
      const customHandler = new InteractionHandler(state, mockAsyncCoordinator, {
        debounceDelay: 500,
  ...
  describe('Error Handling', () => {
    it('should handle errors gracefully during click processing', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Error processing click event:', expect.any(Error));
  ...
  describe('State Queries', () => {
    ...
    it('should track recent clicks count', () => {
      ...
      const trackingHandler = new InteractionHandler(state, mockAsyncCoordinator, {
        enableClickDebouncing: true,
      });
      const node = createTestNode('node1', 'Short');
      state.addNode(node);
  ...
  describe('Cleanup', () => {
    ...
    it('should cleanup pending operations and recent clicks', () => {
      ...
      const cleanupHandler = new InteractionHandler(state, mockAsyncCoordinator, {
        enableClickDebouncing: true,
      });
      const node = createTestNode('node1', 'Short');
      state.addNode(node);
