...
} from "../components/SearchInput.js";
...
describe("SearchInput Component", () => {
  ...
  describe("Search Results Display", () => {
    it("should display result count when there are results", () => {
      render(
        <SearchInput {...defaultProps} searchResults={mockSearchResults} />,
      );
  ...
  describe("Navigation Controls", () => {
    ...
    it("should render navigation buttons when there are results", () => {
      ...
      expect(
        screen.getByRole("button", { name: /previous result/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("button", { name: /next result/i }),
      ).toBeInTheDocument();
    });
    ...
    it("should call onNavigateNext when next button is clicked", () => {
      ...
      render(
        <SearchInput {...propsWithResults} onNavigateNext={onNavigateNext} />,
      );
