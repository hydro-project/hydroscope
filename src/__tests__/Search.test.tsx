...
describe('Search Component', () => {
  ...
  describe('Integration Behavior', () => {
    it('should render both search input and results', () => {
      ...
      expect(screen.getByTestId('search-result-container1')).toBeInTheDocument();
    });
    ...
    it('should navigate through results with keyboard', async () => {
      ...
      render(<Search {...defaultProps} searchResults={mockSearchResults} onResultSelect={onResultSelect} />);
    ...
    it('should clear search and results', () => {
      const onClear = vi.fn();
      render(<Search {...defaultProps} onClear={onClear} searchResults={mockSearchResults} query="test" />);
  ...
  describe('Search State Synchronization', () => {
    it('should reset navigation when search results change', () => {
      const { rerender } = render(<Search {...defaultProps} searchResults={mockSearchResults} />);
  ...
  describe('Accessibility Integration', () => {
    it('should announce search results to screen readers', () => {
      ...
      const resultsContainer = screen.getByRole('list', { name: /search results/i });
