...
import { createTestNode, createTestContainer, createTestEdge } from '../utils/testData.js';
...
describe('VisualizationState Search Functionality', () => {
  ...
  describe('Search Algorithms', () => {
    beforeEach(() => {
      ...
      const container1 = createTestContainer('container1', ['node1'], 'Frontend Code');
      const container2 = createTestContainer('container2', ['node2'], 'Backend Scripts');
  ...
  describe('Advanced Search Features', () => {
    beforeEach(() => {
      ...
      const container1 = createTestContainer('container1', ['node1'], 'Test Container');
