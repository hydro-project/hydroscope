...
describe("FileUpload Component", () => {
  describe("Rendering", () => {
    it("renders upload area with correct initial state", () => {
      ...
      expect(
        screen.getByText("Drop a JSON file here or click to select"),
      ).toBeInTheDocument();
    ...
    it("renders with custom accepted types and max file size", () => {
      ...
      expect(
        screen.getByText(/Supported formats: \.json, \.txt/),
      ).toBeInTheDocument();
        ...
        expect(onValidationError).toHaveBeenCalledWith(
          expect.arrayContaining([
            expect.objectContaining({
              ...
              message: expect.stringContaining(
                "Custom validation failed: Validator crashed",
              ),
            }),
          ]),
          "test.json",
  ...
  describe("Successful File Processing", () => {
    ...
    it("shows success message after successful upload", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Successfully loaded paxos.json"),
        ).toBeInTheDocument();
      });
    });
  });
