...
const exampleData: HydroscopeData = {
  nodes: [
    ...
    { id: 'node2', label: 'Process', fullLabel: 'Processing Node', shortLabel: 'Proc' },
    { id: 'node3', label: 'Output', fullLabel: 'Output Node', shortLabel: 'Out' },
  ],
  edges: [
  ...
  containers: [
    { id: 'container1', label: 'Main Process', children: ['node1', 'node2', 'node3'] }
  ]
};
